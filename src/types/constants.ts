...
export class Contracts {
    ...
    public DaiStartBlock: number;
    public UsdcAddress: string;
    public UsdcStartBlock: number;
    public UsdtAddress: string;
    public UsdtStartBlock: number;
    ...
    public VaultStartBlock: number;
    public VaultDAIAddress: string;
    public VaultDAIStartBlock: number;
    public VaultUSDCAddress: string;
    public VaultUSDCStartBlock: number;
    public VaultUSDTAddress: string;
    public VaultUSDTStartBlock: number;
    public VaultAdapterAddress: string;
    public VaultAdapterStartBlock: number;
    public ConvexStrategyAddress: string;
    public ConvexStrategyStartBlock: number;
    public PrimaryStratDAIAddress: string;
    public PrimaryStratDAIStartBlock: number;
    public SecondaryStratDAIAddress: string;
    public SecondaryStratDAIStartBlock: number;
    public PrimaryStratUSDCAddress: string;
    public PrimaryStratUSDCStartBlock: number;
    public SecondaryStratUSDCAddress: string;
    public SecondaryStratUSDCStartBlock: number;
    public PrimaryStratUSDTAddress: string;
    public PrimaryStratUSDTStartBlock: number;
